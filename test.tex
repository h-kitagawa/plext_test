...
\setbox0=\hbox{\hbox to20pt{\hss あabc}\tabcolsep\z@%
  ...
  \kern-\dimexpr 20pt+\wd0 \box0\kern4em%
  \kern3em%
  \setbox0=\hbox{%
    \begin{tabular}#2[#1]{c}
  ...
  \vtop{\BASEDIR\normalsize\adjustbaseline\noindent
 	\textbf{\kern5zw未読込}
	  \begin{description}
	   ...
	   \item[Math] $\A{c}{}$
	   \item[Bottom] \leavevmode\kern4zw\A{b}{}
	  \end{description}
  }}
\let\A=\At\LTORIG o
\let\A=\Ap\LTORIG p
...
\def\PLT#1#2{%
  ...
  \def\makelabel##1{\hbox to 4em{##1\hss}}
	 ...
	 \item[Math] $\A{c}{<#2>}$
     \item[Bottom] \leavevmode\kern4zw\A{b}{<#2>}
  \end{description}}}
